...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__46823_SHARP_,p2__46822_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__46822_SHARP_) : pred.call(null,p2__46822_SHARP_)))){
return p1__46823_SHARP_;
} else {
return null;
}
}),v);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__46831_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__46831_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__46831_SHARP_) <= ending)));
}));
});
...
var len__4736__auto___46900 = arguments.length;
var i__4737__auto___46901 = (0);
while(true){
if((i__4737__auto___46901 < len__4736__auto___46900)){
args__4742__auto__.push((arguments[i__4737__auto___46901]));

var G__46904 = (i__4737__auto___46901 + (1));
i__4737__auto___46901 = G__46904;
continue;
} else {
}
break;
...
(day8.re_frame_10x.utils.utils.pluralize.cljs$core$IFn$_invoke$arity$variadic = (function (num,singular,p__46862){
var vec__46863 = p__46862;
var plural = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46863,(0),null);
...
/** @this {Function} */
(day8.re_frame_10x.utils.utils.pluralize.cljs$lang$applyTo = (function (seq46848){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46849,G__46850,seq46848__$2);
}));
...
(day8.re_frame_10x.utils.utils.pluralize_.cljs$core$IFn$_invoke$arity$variadic = (function (num,singular,p__46882){
var vec__46885 = p__46882;
var plural = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46885,(0),null);
...
/** @this {Function} */
(day8.re_frame_10x.utils.utils.pluralize_.cljs$lang$applyTo = (function (seq46870){
var G__46871 = cljs.core.first(seq46870);
var seq46870__$1 = cljs.core.next(seq46870);
var G__46872 = cljs.core.first(seq46870__$1);
var seq46870__$2 = cljs.core.next(seq46870__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46871,G__46872,seq46870__$2);
}));
