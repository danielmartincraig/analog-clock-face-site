...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k49694,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49694,else__4383__auto__);
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49693){
var self__ = this;
var G__49693__$1 = this;
return (new cljs.core.RecordIter((0),G__49693__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49695,other49696){
var self__ = this;
var this49695__$1 = this;
return (((!((other49696 == null)))) && ((this49695__$1.constructor === other49696.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49695__$1.whitespace,other49696.whitespace)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49695__$1.__extmap,other49696.__extmap)));
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__49693){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__49728 = cljs.core.keyword_identical_QMARK_;
var expr__49729 = k__4388__auto__;
if(cljs.core.truth_((pred__49728.cljs$core$IFn$_invoke$arity$2 ? pred__49728.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__49729) : pred__49728.call(null,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__49729)))){
return (new rewrite_clj.node.whitespace.WhitespaceNode(G__49693,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__49693),null));
}
}));
...
(rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__49693){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,G__49693,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_WhitespaceNode = (function rewrite_clj$node$whitespace$map__GT_WhitespaceNode(G__49697){
var extmap__4419__auto__ = (function (){var G__49746 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__49697,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483));
if(cljs.core.record_QMARK_(G__49697)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49746);
} else {
return G__49746;
}
})();
return (new rewrite_clj.node.whitespace.WhitespaceNode(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483).cljs$core$IFn$_invoke$arity$1(G__49697),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k49750,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__49760 = k49750;
var G__49760__$1 = (((G__49760 instanceof cljs.core.Keyword))?G__49760.fqn:null);
switch (G__49760__$1) {
case "newlines":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49750,else__4383__auto__);
...
var self__ = this;
var this__4399__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__49768){
var vec__49770 = p__49768;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49770,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49770,(1),null);
return (f__4400__auto__.cljs$core$IFn$_invoke$arity$3 ? f__4400__auto__.cljs$core$IFn$_invoke$arity$3(ret__4402__auto__,k__4403__auto__,v__4404__auto__) : f__4400__auto__.call(null,ret__4402__auto__,k__4403__auto__,v__4404__auto__));
}),init__4401__auto__,this__4399__auto____$1);
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49749){
var self__ = this;
var G__49749__$1 = this;
return (new cljs.core.RecordIter((0),G__49749__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"newlines","newlines",-1185451518)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49751,other49752){
var self__ = this;
var this49751__$1 = this;
return (((!((other49752 == null)))) && ((this49751__$1.constructor === other49752.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49751__$1.newlines,other49752.newlines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49751__$1.__extmap,other49752.__extmap)));
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__49749){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__49808 = cljs.core.keyword_identical_QMARK_;
var expr__49809 = k__4388__auto__;
if(cljs.core.truth_((pred__49808.cljs$core$IFn$_invoke$arity$2 ? pred__49808.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__49809) : pred__49808.call(null,new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__49809)))){
return (new rewrite_clj.node.whitespace.NewlineNode(G__49749,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__49749),null));
}
}));
...
(rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__49749){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,G__49749,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.whitespace.map__GT_NewlineNode = (function rewrite_clj$node$whitespace$map__GT_NewlineNode(G__49754){
var extmap__4419__auto__ = (function (){var G__49831 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__49754,new cljs.core.Keyword(null,"newlines","newlines",-1185451518));
if(cljs.core.record_QMARK_(G__49754)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49831);
} else {
return G__49831;
}
})();
return (new rewrite_clj.node.whitespace.NewlineNode(new cljs.core.Keyword(null,"newlines","newlines",-1185451518).cljs$core$IFn$_invoke$arity$1(G__49754),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var comma_49998 = rewrite_clj.node.whitespace.whitespace_node(", ");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(comma_49998)));
});
var nl_50004 = rewrite_clj.node.whitespace.newline_node("\n");
/**
...
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(nl_50004)));
});
var space_50006 = rewrite_clj.node.whitespace.whitespace_node(" ");
/**
 * Interleave the given seq of nodes with `" "` nodes.
 */
rewrite_clj.node.whitespace.space_separated = (function rewrite_clj$node$whitespace$space_separated(nodes){
return cljs.core.butlast(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(nodes,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(space_50006)));
});
/**
