...
var o42062 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42062["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42064 = temp__5733__auto____$1;
return (o42064["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41202__auto__ = f;
return (o__41202__auto__["toString"]).call(o__41202__auto__);
} else {
return "";
}
}catch (e42076){var _ = e42076;
return "";
}});
...
try{var o__41202__auto___42402 = t;
(o__41202__auto___42402["cljs$lang$ctorPrWriter"]).call(o__41202__auto___42402,t,writer);
}catch (e42089){var __42403 = e42089;
}
...
var char_code = (function (){var o__41202__auto__ = (new String(char$));
return (o__41202__auto__["charCodeAt"]).call(o__41202__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41202__auto__ = String;
return (o__41202__auto__["fromCharCode"]).call(o__41202__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42107 = num_code;
switch (G__42107) {
case (1):
return (185);
...
var o__41202__auto__ = String;
return (o__41202__auto__["fromCharCode"]).call(o__41202__auto__,superscript_code);
});
/**
...
}catch (e42133){var _e__41213__auto__ = e42133;
return false;
}})())){
...
var vec__42138 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42138,(0),null);
...
args__4742__auto__.push((arguments[i__4737__auto___42431]));

var G__42433 = (i__4737__auto___42431 + (1));
i__4737__auto___42431 = G__42433;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42170){
var vec__42171 = p__42170;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42171,(0),null);
...
var G__42438 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42439 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42438;
remaining_tokens = G__42439;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42163){
var G__42164 = cljs.core.first(seq42163);
var seq42163__$1 = cljs.core.next(seq42163);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42164,seq42163__$1);
}));
...
var vec__42181 = cljs.core.split_with((function (p1__42180_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42180_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42181,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42181,(1),null);
...
var vec__42189 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42189,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42189,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42447 = cljs.core.rest(remaining_tokens);
var G__42448 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42447;
name_tokens = G__42448;
continue;
} else {
...
var vec__42206 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42206,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42206,(1),null);
var vec__42209 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42209,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42209,(1),null);
var vec__42212 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42212,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42212,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42212,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42212,(3),null);
...
var vec__42231 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42231,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42231,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42231,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42231,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42231,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42231,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42252 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42252,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42252,(1),null);
var vec__42256 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42256,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42256,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42283 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42283) : devtools.munging.parse_fn_info_deep.call(null,G__42283));
})()));
}
} else {
return fn_info;
...
var G__42476 = (arity + (1));
var G__42477 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42302){
var vec__42303 = p__42302;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42303,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42303,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42308_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42308_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42310_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42310_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42320){
var vec__42321 = p__42320;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42321,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42317){
var G__42318 = cljs.core.first(seq42317);
var seq42317__$1 = cljs.core.next(seq42317);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42318,seq42317__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42343__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42343__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42343__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42343__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42345 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42345,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42345,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42345,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42345,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42345,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42345,(5),null);
...
var o__41202__auto__ = f;
return (o__41202__auto__["getBasis"]).call(o__41202__auto__);
});
/**
...
}catch (e42354){var _e__41213__auto__ = e42354;
...
var G__42516 = (obj[cljs.core.first(path)]);
var G__42517 = cljs.core.rest(path);
obj = G__42516;
path = G__42517;
continue;
} else {
...
var _STAR_ = (function (accum,p__42372){
var vec__42373 = p__42372;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42373,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42373,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42382){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42383,(2),null);
...
var post_process = (function (p__42390){
var vec__42394 = p__42390;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42394,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42394,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42388_SHARP_){
return (obj[cljs.core.first(p1__42388_SHARP_)]);
}),sorted_matches);
