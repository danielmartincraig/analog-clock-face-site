...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42469){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42481_SHARP_){
return (!((cljs.core.meta(p1__42481_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42489__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42498){var _e__41213__auto__ = e42498;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42500){var _e__41213__auto__ = e42500;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42504 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42505 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42505);

try{var map__42506 = opts;
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42504);
}});
...
var temp__5733__auto___42532 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42532)){
var managed_print_level_42533 = temp__5733__auto___42532;
var _STAR_print_level_STAR__orig_val__42514_42534 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42515_42535 = managed_print_level_42533;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42515_42535);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42513_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42513_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42514_42534);
}} else {
job_fn();
}
