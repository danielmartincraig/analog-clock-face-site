...
var vec__54106 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__54109 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54109,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54109,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54106,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54106,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__54114){
var vec__54115 = p__54114;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54115,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54115,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54119,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54119,(1),null);
...
var vec__54154 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54154,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54154,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54154,(2),null);
var vec__54157 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54157,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54157,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54157,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__54189){
var vec__54190 = p__54189;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54190,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54190,(1),null);
...
args__4742__auto__.push((arguments[i__4737__auto___54316]));
...
var vec__54203 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54203,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54203,(1),null);
...
var G__54206 = zprint.core.parse_string_all_options(rest_options);
var G__54207 = zprint.core.zprint_str_internal;
var G__54208 = ":parse-string-all? call";
var G__54209 = (function (){var G__54210 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__54210) : zprint.zutil.edn_STAR_.call(null,G__54210));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__54206,G__54207,G__54208,G__54209) : zprint.core.process_multiple_forms.call(null,G__54206,G__54207,G__54208,G__54209));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__54216 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54216,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54216,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq54199){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54200,G__54201,seq54199__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___54340 = arguments.length;
var i__4737__auto___54342 = (0);
while(true){
if((i__4737__auto___54342 < len__4736__auto___54340)){
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq54225){
...
var i__4737__auto___54355 = (0);
while(true){
if((i__4737__auto___54355 < len__4736__auto___54353)){
args__4742__auto__.push((arguments[i__4737__auto___54355]));

var G__54356 = (i__4737__auto___54355 + (1));
i__4737__auto___54355 = G__54356;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq54229){
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq54231){
var G__54232 = cljs.core.first(seq54231);
var seq54231__$1 = cljs.core.next(seq54231);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54232,seq54231__$1);
}));
...
var G__54373 = (i__4737__auto___54371 + (1));
i__4737__auto___54371 = G__54373;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq54233){
var G__54234 = cljs.core.first(seq54233);
var seq54233__$1 = cljs.core.next(seq54233);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54234,seq54233__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__54239,form){
var vec__54240 = p__54239;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54240,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54240,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54240,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54240,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__54246 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54246,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54246,(1),null);
...
var forms = (function (){var G__54274 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__54274) : zprint.zutil.edn_STAR_.call(null,G__54274));
})();
