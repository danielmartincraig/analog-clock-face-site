...
var G__50650 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__50650__$1 = (((G__50650 == null))?null:cljs.core.iterate((function (loc){
...
var G__50650__$2 = (((G__50650__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50650__$1));
var G__50650__$3 = (((G__50650__$2 == null))?null:cljs.core.last(G__50650__$2));
if((G__50650__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__50650__$3);
}
} else {
return zloc;
}
...
var G__50691 = rewrite_clj.zip.move.right(v);
var G__50692 = rewrite_clj.zip.move.up(v);
loc = G__50691;
parent = G__50692;
continue;
} else {
var G__50694 = rewrite_clj.zip.move.right(v0);
var G__50695 = parent;
loc = G__50694;
parent = G__50695;
continue;
...
var G__50699 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__50700 = rewrite_clj.zip.move.up(v);
loc = G__50699;
parent = G__50700;
continue;
} else {
var G__50701 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__50702 = parent;
loc = G__50701;
parent = G__50702;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__50674 = zloc;
var G__50674__$1 = (((G__50674 == null))?null:rewrite_clj.zip.move.down(G__50674));
var G__50674__$2 = (((G__50674__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__50674__$1,k));
if((G__50674__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__50674__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__50675 = rewrite_clj.zip.move.down(zloc);
var G__50675__$1 = (((G__50675 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__50675));
if((G__50675__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50675__$1);
}
})(),k);
}
});
