...
if((i < len)){
var k = (ks[i]);
var G__47117 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__47118 = (i + (1));
m = G__47117;
i = G__47118;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__47009 = c;
var G__47009__$1 = (((G__47009 == null))?null:G__47009.prototype);
if((G__47009__$1 == null)){
return null;
} else {
return G__47009__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__47013 = c;
var G__47013__$1 = (((G__47013 == null))?null:G__47013.prototype);
if((G__47013__$1 == null)){
return null;
} else {
return G__47013__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__47141__delegate = function (args){
var G__47036 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__47036) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.call(null,G__47036));
};
...
while (G__47146__i < G__47146__a.length) {G__47146__a[G__47146__i] = arguments[G__47146__i + 0]; ++G__47146__i;}
  args = new cljs.core.IndexedSeq(G__47146__a,0,null);
} 
return G__47141__delegate.call(this,args);};
G__47141.cljs$lang$maxFixedArity = 0;
G__47141.cljs$lang$applyTo = (function (arglist__47153){
var args = cljs.core.seq(arglist__47153);
return G__47141__delegate(args);
});
...
var G__47038 = c;
var G__47038__$1 = (((G__47038 == null))?null:G__47038.constructor);
if((G__47038__$1 == null)){
return null;
} else {
return G__47038__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__47045 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__47046 = c;
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__47046);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__47045);
}});
...
var c = this;
var G__47070_47208 = goog.object.get(c,"cljsRatom");
if((G__47070_47208 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.ratom.dispose_BANG_(G__47070_47208);
}
...
var renders_47224 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_47225 = cljs.core.first(cljs.core.vals(renders_47224));
...
if((cljs.core.count(renders_47224) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_47224))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_47225)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_47225], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__47101 = o;
goog.object.set(G__47101,cljs.core.name(k),v);
