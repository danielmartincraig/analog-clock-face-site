...
var G__51845 = o;
goog.object.set(G__51845,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51921__delegate = function (args){
...
while (G__51922__i < G__51922__a.length) {G__51922__a[G__51922__i] = arguments[G__51922__i + 0]; ++G__51922__i;}
  args = new cljs.core.IndexedSeq(G__51922__a,0,null);
} 
return G__51921__delegate.call(this,args);};
G__51921.cljs$lang$maxFixedArity = 0;
G__51921.cljs$lang$applyTo = (function (arglist__51923){
var args = cljs.core.seq(arglist__51923);
return G__51921__delegate(args);
});
...
var G__51848 = o;
goog.object.set(G__51848,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51925__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__51925__delegate.call(this,args);};
G__51925.cljs$lang$maxFixedArity = 0;
G__51925.cljs$lang$applyTo = (function (arglist__51927){
var args = cljs.core.seq(arglist__51927);
return G__51925__delegate(args);
});
...
var G__51851 = props;
var G__51851__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51851,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51851);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51851__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__51851__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51852 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51852,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51852;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51856){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51857__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__51862_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51862_SHARP_);
}));
} else {
return null;
}
...
var vec__51869 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51869,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51869,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51869,(2),null);
...
var temp__5739__auto___51945 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___51945 == null)){
} else {
var key_51946 = temp__5739__auto___51945;
(jsprops.key = key_51946);
}
...
var temp__5739__auto___51947 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___51947 == null)){
} else {
var key_51948 = temp__5739__auto___51947;
(jsprops.key = key_51948);
}
...
var G__51880 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__51880) : reagent.impl.template.as_element.call(null,G__51880));
} else {
var temp__5739__auto___51949 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___51949 == null)){
} else {
var key_51950 = temp__5739__auto___51949;
(jsprops.key = key_51950);
}
...
var G__51883 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__51883)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__51883)){
return x;
} else {
...
var len__4736__auto___51952 = arguments.length;
var i__4737__auto___51953 = (0);
while(true){
if((i__4737__auto___51953 < len__4736__auto___51952)){
args__4742__auto__.push((arguments[i__4737__auto___51953]));

var G__51954 = (i__4737__auto___51953 + (1));
i__4737__auto___51953 = G__51954;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51884){
...
break;
default:
var G__51984 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__51984;
continue;
...
var ctx = ({});
var vec__51904 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51904,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51904,(1),null);
...
var G__51910 = (cljs.core.count(argv) - first_child);
switch (G__51910) {
case (0):
