...
var len__4736__auto___50154 = arguments.length;
var i__4737__auto___50155 = (0);
while(true){
if((i__4737__auto___50155 < len__4736__auto___50154)){
args__4742__auto__.push((arguments[i__4737__auto___50155]));

var G__50156 = (i__4737__auto___50155 + (1));
i__4737__auto___50155 = G__50156;
continue;
} else {
}
break;
...
/** @this {Function} */
(rewrite_clj.reader.throw_reader.cljs$lang$applyTo = (function (seq50099){
var G__50100 = cljs.core.first(seq50099);
var seq50099__$1 = cljs.core.next(seq50099);
var G__50101 = cljs.core.first(seq50099__$1);
var seq50099__$2 = cljs.core.next(seq50099__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50100,G__50101,seq50099__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(rewrite_clj.reader.read_until(reader,(function (p1__50138_SHARP_){
return (((p1__50138_SHARP_ == null)) || (rewrite_clj.reader.linebreak_QMARK_(p1__50138_SHARP_)));
...
var G__50165 = (cljs.core.truth_((p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(v) : p_QMARK_.call(null,v)))?(c + (1)):c);
var G__50166 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vs,v);
c = G__50165;
vs = G__50166;
continue;
} else {
