...
if((c === "\n")){
var G__50252 = escape_QMARK_;
var G__50253 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__50252;
lines = G__50253;
continue;
} else {
buf.append(c);

var G__50254 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__50255 = lines;
escape_QMARK_ = G__50254;
lines = G__50255;
continue;
...
var G__50241 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__50241) : rewrite_clj.node.string_node.call(null,G__50241));
});
...
var G__50245 = cljs.core.re_pattern(regex);
var G__50246 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__50245,G__50246) : rewrite_clj.node.token_node.call(null,G__50245,G__50246));
});
