...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__49038_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__49038_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__49038_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__49041){
var vec__49045 = p__49041;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49045,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49045,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__49055,s,color,element,idx){
var map__49057 = p__49055;
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49057__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49057__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49057__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__49070 = (function (){var or__4126__auto__ = color;
...
var fexpr__49069 = (function (){var G__49071 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__49071) : style_map.call(null,G__49071));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__49072){
var vec__49073 = p__49072;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49073,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49073,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49073,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__49081){
var vec__49082 = p__49081;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49082,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49082,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49082,(2),null);
...
var G__49411 = cljs.core.next(ssv);
var G__49412 = (this_ssv == null);
var G__49413 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__49414 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__49411;
doing_nil_QMARK_ = G__49412;
last_elide = G__49413;
out = G__49414;
continue;
}
...
var vec__49140 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49140,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49140,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49140,(2),null);
...
var G__49420 = cljs.core.next(remaining_cvec);
var G__49421 = new_idx;
var G__49422 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__49420;
idx = G__49421;
out = G__49422;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__49210,cursor_vec){
var vec__49211 = p__49210;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49211,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49211,(1),null);
var focus_vec = vec__49211;
...
var vec__49216 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49216,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49216,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__49222){
var vec__49224 = p__49222;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49224,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49224,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__49236,existing_count){
var vec__49237 = p__49236;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49237,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49237,(1),null);
...
return cljs.core.filterv((function (p1__49230_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__49230_SHARP_))));
...
var vec__49266 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49266,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49266,(1),null);
var cvec_element = vec__49266;
if((cvec_element == null)){
var G__49443 = cljs.core.next(cvec_nl);
var G__49444 = (idx + (1));
var G__49445 = start;
var G__49446 = out;
cvec_nl = G__49443;
...
var G__49447 = cljs.core.next(cvec_nl);
var G__49448 = (idx + (1));
var G__49449 = idx;
var G__49450 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__49447;
idx = G__49448;
start = G__49449;
out = G__49450;
...
var G__49451 = cljs.core.next(cvec_nl);
var G__49452 = (idx + (1));
var G__49453 = (idx + (1));
var G__49454 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__49451;
idx = G__49452;
start = G__49453;
out = G__49454;
...
var G__49457 = cljs.core.next(cvec_nl);
var G__49458 = (idx + (1));
var G__49459 = idx;
var G__49460 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__49457;
idx = G__49458;
start = G__49459;
out = G__49460;
...
var G__49461 = cljs.core.next(cvec_nl);
var G__49462 = (idx + (1));
var G__49463 = start;
var G__49464 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__49461;
idx = G__49462;
start = G__49463;
out = G__49464;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49276_SHARP_,p2__49275_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__49275_SHARP_)){
return cljs.core.reduced(p1__49276_SHARP_);
} else {
return (p1__49276_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__49301,p__49302){
var vec__49304 = p__49301;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49304,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49304,(1),null);
var vec__49307 = p__49302;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49307,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49307,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__49347,cvec,focus_vec){
var map__49349 = p__49347;
...
var options = map__49349__$1;
var map__49350 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49349__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49350__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49350__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49350__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49339_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__49339_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
