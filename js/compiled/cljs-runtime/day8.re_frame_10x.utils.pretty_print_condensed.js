...
var day8$re_frame_10x$utils$pretty_print_condensed$ILimited$_limited_QMARK_$dyn_50945 = (function (x){
...
return day8$re_frame_10x$utils$pretty_print_condensed$ILimited$_limited_QMARK_$dyn_50945(x);
}
});
...
return [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__50687 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50681__$1)].join('')));
...
var G__50962 = clojure.string.replace(s,match,trunc_prefix);
var G__50963 = limit;
var G__50964 = match;
var G__50965 = trunc_prefix;
s = G__50962;
limit = G__50963;
match = G__50964;
trunc_prefix = G__50965;
continue;
}
}
break;
...
var prefix = (function (){var G__50834 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__50834,"\u2026/"].join('');
} else {
return G__50834;
}
})();
...
var vec__50846 = day8.re_frame_10x.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50846,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50846,(1),null);
...
var or__4126__auto__ = (function (){var G__50865 = form.name;
if((G__50865 == null)){
return null;
} else {
return clojure.string.replace(G__50865,/(^.*\$)(.*)/,"$2");
}
})();
...
var G__50879 = obj;
var G__50880 = writer;
var G__50881 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.utils.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__50879,G__50880,G__50881) : alt_impl.call(null,G__50879,G__50880,G__50881));
} else {
...
var seq__50884 = cljs.core.seq(cljs.core.next(objs));
var chunk__50885 = null;
var count__50886 = (0);
var i__50887 = (0);
while(true){
if((i__50887 < count__50886)){
var obj = chunk__50885.cljs$core$IIndexed$_nth$arity$2(null,i__50887);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__50982 = seq__50884;
var G__50983 = chunk__50885;
var G__50984 = count__50886;
var G__50985 = (i__50887 + (1));
seq__50884 = G__50982;
chunk__50885 = G__50983;
count__50886 = G__50984;
i__50887 = G__50985;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__50884);
if(temp__5735__auto__){
var seq__50884__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50884__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__50884__$1);
var G__50986 = cljs.core.chunk_rest(seq__50884__$1);
var G__50987 = c__4556__auto__;
var G__50988 = cljs.core.count(c__4556__auto__);
var G__50989 = (0);
seq__50884 = G__50986;
chunk__50885 = G__50987;
count__50886 = G__50988;
i__50887 = G__50989;
continue;
} else {
var obj = cljs.core.first(seq__50884__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__50990 = cljs.core.next(seq__50884__$1);
var G__50991 = null;
var G__50992 = (0);
var G__50994 = (0);
seq__50884 = G__50990;
chunk__50885 = G__50991;
count__50886 = G__50992;
i__50887 = G__50994;
continue;
}
} else {
...
var len__4736__auto___51019 = arguments.length;
var i__4737__auto___51020 = (0);
while(true){
if((i__4737__auto___51020 < len__4736__auto___51019)){
args__4742__auto__.push((arguments[i__4737__auto___51020]));

var G__51021 = (i__4737__auto___51020 + (1));
i__4737__auto___51020 = G__51021;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq50936){
var G__50937 = cljs.core.first(seq50936);
var seq50936__$1 = cljs.core.next(seq50936);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50937,seq50936__$1);
}));
