...
while (G__47407__i < G__47407__a.length) {G__47407__a[G__47407__i] = arguments[G__47407__i + 0]; ++G__47407__i;}
  args = new cljs.core.IndexedSeq(G__47407__a,0,null);
} 
...
var G__47304 = o;
goog.object.set(G__47304,day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__47414__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__47414 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__47415__i = 0, G__47415__a = new Array(arguments.length -  0);
while (G__47415__i < G__47415__a.length) {G__47415__a[G__47415__i] = arguments[G__47415__i + 0]; ++G__47415__i;}
  args = new cljs.core.IndexedSeq(G__47415__a,0,null);
} 
return G__47414__delegate.call(this,args);};
G__47414.cljs$lang$maxFixedArity = 0;
G__47414.cljs$lang$applyTo = (function (arglist__47416){
var args = cljs.core.seq(arglist__47416);
return G__47414__delegate(args);
});
...
var G__47308 = props;
var G__47308__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47308,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__47308);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47308__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__47308__$1;
}
});
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.set_id_class((function (){var G__47309 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47309,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__47309;
}
})(),id_class);
...
day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v10v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__47314){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47315__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__47325_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_handle_change(this$,on_change,p1__47325_SHARP_);
}));
} else {
return null;
}
...
var vec__47332 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47332,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47332,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47332,(2),null);
...
var temp__5739__auto___47463 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___47463 == null)){
} else {
var key_47464 = temp__5739__auto___47463;
(jsprops.key = key_47464);
}
...
var temp__5739__auto___47472 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___47472 == null)){
} else {
var key_47473 = temp__5739__auto___47472;
(jsprops.key = key_47473);
}
...
var G__47336 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__47336) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.call(null,G__47336));
} else {
var temp__5739__auto___47476 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___47476 == null)){
} else {
var key_47477 = temp__5739__auto___47476;
(jsprops.key = key_47477);
}
...
var G__47338 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__47338)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__47338)){
return x;
} else {
...
var G__47482 = (i__4737__auto___47481 + (1));
i__4737__auto___47481 = G__47482;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq47339){
var G__47340 = cljs.core.first(seq47339);
var seq47339__$1 = cljs.core.next(seq47339);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47340,seq47339__$1);
}));
...
break;
default:
var G__47493 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__47493;
continue;
...
var ctx = ({});
var vec__47362 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47362,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47362,(1),null);
...
var G__47375 = (cljs.core.count(argv) - first_child);
switch (G__47375) {
case (0):
