 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__45434){
var vec__45435 = p__45434;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45435,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45435,(1),null);
return (function (s){
...
var i__4737__auto___45521 = (0);
while(true){
if((i__4737__auto___45521 < len__4736__auto___45519)){
args__4742__auto__.push((arguments[i__4737__auto___45521]));

var G__45522 = (i__4737__auto___45521 + (1));
i__4737__auto___45521 = G__45522;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__45444_SHARP_){
return (p1__45444_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__45444_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__45444_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq45453){
...
var map__45487 = temp__5733__auto__;
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45487__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45487__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45487__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__45549 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__45550 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__45497 = tag;
