...
}catch (e44809){var _e__41213__auto__ = e44809;
return false;
...
}catch (e44816){var _e__41213__auto__ = e44816;
return false;
...
}catch (e44836){var _e__41213__auto__ = e44836;
return false;
...
}catch (e44841){var _e__41213__auto__ = e44841;
return false;
...
}catch (e44847){var _e__41213__auto__ = e44847;
return false;
}})())){
...
}catch (e44849){var _e__41213__auto__ = e44849;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__44857 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__44858 = (function (){var or__4126__auto__ = config;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__44858);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__44857);
}});
});
...
return (function() { 
var G__44875__delegate = function (args){
...
var G__44883__i = 0, G__44883__a = new Array(arguments.length -  0);
while (G__44883__i < G__44883__a.length) {G__44883__a[G__44883__i] = arguments[G__44883__i + 0]; ++G__44883__i;}
  args = new cljs.core.IndexedSeq(G__44883__a,0,null);
} 
return G__44875__delegate.call(this,args);};
G__44875.cljs$lang$maxFixedArity = 0;
G__44875.cljs$lang$applyTo = (function (arglist__44884){
var args = cljs.core.seq(arglist__44884);
return G__44875__delegate(args);
});
